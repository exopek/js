              ...
              TextButton(
                style: ButtonStyle(
                  ...
                  backgroundColor: MaterialStateProperty.resolveWith((Set<MaterialState> states) {
                    return states.contains(MaterialState.disabled) ? null : Colors.orangeAccent;
                  }),
                ),
                onPressed: () {
                  Authentication().login(_usernameTextController.text, _passwordTextController.text).then((value) {
                    if (value.success) {
